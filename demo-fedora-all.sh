...
NUM_NEXT_THINKERS=4
NUM_TOKENS=3
VISUALIZER_ADDRESS=192.168.50.10:3334
INIT_SERVER_ADDRESS=192.168.50.10:3333
...
sleep 0.5
ptyxis --new-window -- bash -c "./fedora-thinkers.sh 5"
sleep 0.5
ptyxis --new-window -- bash -c "./fedora-forks.sh 4"
sleep 0.5
